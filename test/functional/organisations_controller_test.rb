...
class OrganisationsControllerTest < ActionController::TestCase
  ...
  test "should create organisation" do
    assert_difference('Organisation.count') do
      post :create, organisation: { description: @organisation.description, link: @organisation.link, name: @organisation.name }
    end
  ...
  test "should update organisation" do
    put :update, id: @organisation, organisation: { description: @organisation.description, link: @organisation.link, name: @organisation.name }
    assert_redirected_to organisation_path(assigns(:organisation))
  end
